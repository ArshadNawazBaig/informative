...
const PrivacyPolicy = () => {
  return (
    <Box className="container privacy-policy py-3">
      <Box className="row">
        <Box className="col-12">
          <h1>Privacy Policy</h1>
          <Para>Last updated: September 25, 2023</Para>
          <Para>
          ...
          <ul>
            ...
            <li>
              <Para>
                ...
                in this Agreement) refers to Informative, Prince colony near
                Qaid-e-Azam road Gilgit.
              </Para>
            </li>
            <li>
              <Para>
            ...
            <li>
              <Para>
                <strong>Website</strong> refers to Informative writes,
                accessible from{' '}
                <a
                  href="https://informative-eta.vercel.app"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://informative-eta.vercel.app
                </a>
              </Para>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <Para>First name and last name</Para>
            </li>
            <li>
              <Para>Address, State, Province, ZIP/Postal code, City</Para>
            </li>
            <li>
              <Para>Usage Data</Para>
            </li>
          </ul>
          <h3>Usage Data</h3>
          <Para>
          ...
          <ul>
            <li>
              ...
              <Para>Type: Session Cookies</Para>
              <Para>Administered by: Us</Para>
              <Para>
            ...
            <li>
              ...
              <Para>Type: Persistent Cookies</Para>
              <Para>Administered by: Us</Para>
              <Para>
          ...
          <ul>
            <li>
              <Para>By email: arshadnawazbaig@gmail.com</Para>
            </li>
            <li>
              <Para>
                By visiting this page on our website:{' '}
                <a
                  href="https://informative-eta.vercel.app/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://informative-eta.vercel.app/contact
                </a>
              </Para>
            </li>
            <li>
              <Para>
                By mail: Quid-e-azam road near prince colony jutial gilgit,
                pakistan
              </Para>
            </li>
          </ul>
